        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Goalfunds = table.Column<decimal>(type: "decimal(18, 0)", nullable: false),
                    Creator_Id = table.Column<long>(nullable: false),
                    Fundsrecv = table.Column<decimal>(type: "decimal(18, 0)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Donation_upperlim = table.Column<decimal>(type: "decimal(18, 0)", nullable: false),
                    Reward = table.Column<string>(unicode: false, maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Backers_projects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Backers_projects_Packages",
                        column: x => x.Package_Id,
                        principalTable: "Packages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Backers_projects_Projects",
                        column: x => x.Project_Id,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Backers_projects_Users",
                        column: x => x.User_Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Backers_projects_Package_Id",
                table: "Backers_projects",
                column: "Package_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Backers_projects_Project_Id",
                table: "Backers_projects",
                column: "Project_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Backers_projects_User_Id",
                table: "Backers_projects",
                column: "User_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Packages_Project_Id",
                table: "Packages",
                column: "Project_Id");
